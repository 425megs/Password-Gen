...
if upperCase === true then choose from upperCase array
if lowerCase === true then choose from upperCase array
if numbers === true then choose from upperCase array
if specialChar === true then choose from upperCase array
